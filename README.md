...
2. Extended properties and results. (An extended version is uploaded to Arxiv. **Explore Inversion and Invariance in Flow Transformer for General Conditional Generation**)
   
3. Unified codebase cleaning.
